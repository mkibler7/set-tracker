  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70">
      <div className="mx-4 w-full flex flex-col overflow-hidden rounded-2xl bg-card shadow-xl max-w-xs sm:max-w-sm md:max-w-md">
        ...
        {/* List area */}
        <div className="px-4 pb-3 text-[13px] sm:text-sm">
...
//     <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70">
//       <div
//         className="mx-4 flex w-full max-w-sm flex-col overflow-hidden rounded-2xl
//                    border border-border bg-card shadow-xl max-h-[80vh]
//                    sm:max-w-md"
//       >
//         {/* Header + search */}
//         <div className="sticky top-0 z-10 bg-card/95 px-4 pb-3 pt-3 backdrop-blur">
//           <div className="mb-2 flex items-center justify-between gap-4">
//             <h2 className="text-[13px] font-semibold text-foreground sm:text-sm my-2 ml-2">
//               Add exercise to session
//             </h2>
...
//         {/* List area – static bordered frame, scrolling inside */}
//         <div className="px-3 pb-3 pt-2 text-[13px] sm:text-sm ">
//           <div className="mx-1 rounded-lg border border-border bg-background/40 sm:mx-0">
//             <div className="max-h-[50vh] overflow-y-auto p-1 sm:p-2">
//               {filteredExercises.length === 0 ? (
//                 <p className="px-2 py-3 text-[11px] text-muted-foreground sm:text-xs">
//                   No exercises match your filters.
//                 </p>
...
//                         type="button"
//                         onClick={() => onSelect(exercise.id)}
//                         className="w-full rounded-md px-3 py-2 text-left text-[13px] text-foreground
//                                    hover:bg-accent/15 hover:text-accent-foreground
//                                    focus:outline-none focus:ring-1 focus:ring-accent/60 sm:text-sm"
//                       >
//                         <div className="truncate font-medium">

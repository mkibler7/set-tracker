...
export default function MobileNavBar() {
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown menu */}
      {open && (
        <div className="absolute right-0 mt-2 w-40 rounded-md border border-slate-700 bg-slate-900/95  text-sm shadow-lg z-50 ">
          <Link
            href="/dashboard"
            onClick={close}
            className="block px-3 py-2 text-slate-100 hover:bg-slate-800 hover:text-primary"
          >
            Dashboard
          </Link>
          <Link
